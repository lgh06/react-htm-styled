import {c as createCommonjsModule}from'./_commonjsHelpers-e2cda605.js';import'./react.production.min-06a73cc7.js';import {r as require$$0}from'./index-6776b35e.js';var l = Object.assign;
...
var la = require$$0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    ma = {};
...
var bb = function () {
  function a(a, b, f) {
    require$$0.isValidElement(a) ? a.type !== r ? a = [a] : (a = a.props.children, a = require$$0.isValidElement(a) ? [a] : Z(a)) : a = Z(a);
    a = {
      type: null,
  ...
  b.render = function (a, b, f) {
    ...
    if ("object" === typeof c && null !== c) switch (c.$$typeof) {
      ...
      case da:
        return a = [require$$0.createElement(c.type, l({
          ref: a.ref
      ...
      case ea:
        return c = a.type, d = c._init, c = d(c._payload), a = [require$$0.createElement(c, l({
          ref: a.ref
        }, a.props))], this.stack.push({
          type: null,
          domNamespace: f,
...
var renderToStaticMarkup = function (a, b) {
  a = new bb(a, !0, b);
...
var renderToString = function (a, b) {
  a = new bb(a, !1, b);
