import { isValidElementType, typeOf, isElement } from 'https://cdn.jsdelivr.net/npm/@webest/es-react@0.0.1/react-is.js';
import r$1, { useState, useContext, useMemo, useEffect, useRef, useDebugValue, createElement } from 'https://cdn.jsdelivr.net/npm/@webest/es-react@0.0.1/react.js';
...
var N = "undefined" != typeof process && (process.env.SC_ATTR) || "data-styled"
  , A = "5.3.3"
...
var re = te("5.3.3")
  , oe = function() {
    function e(e, t, n) {
        this.rules = e,
        this.staticRulesId = "",
        this.isStatic = "production" === process.env.NODE_ENV  ,
        this.componentId = t,
...
function me(e) {
    var t = useState(e.stylisPlugins)
      , n = t[0]
      , s = t[1]
      , c = pe()
      , u = useMemo((function() {
    ...
    r$1.createElement(ce.Provider, {
        value: u
    }, r$1.createElement(le.Provider, {
        value: l
    }, r$1.Children.only(e.children) ))
}
var ye = function() {
    function e(e, t) {
        var n = this;
...
function _e(e, n, r, o) {
    ...
    if (E(e)) {
        if ("function" != typeof (l = e) || l.prototype && l.prototype.isReactComponent || !n)
            return e;
        var u = e(n);
        return isElement(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."),
        _e(u, n, r, o)
    }
    var l;
    ...
    e.getName(o)) : e : g(e) ? function e(t, n) {
        ...
        for (var i in t)
            ...
            null == (o = t[i]) || "boolean" == typeof o || "" === o ? "" : "number" != typeof o || 0 === o || r in unitlessKeys ? String(o).trim() : o + "px") + ";"));
...
function Le(e) {
    ...
    return e.children ? r$1.createElement(Me.Provider, {
        value: n
    }, e.children) : null
}
var Fe = {};
...
function $e(e) {
    ...
    function l(e) {
        var t = pe()
          , n = fe()
          , o = useContext(Me)
          , u = useRef(t.allocateGSInstance(a)).current;
        return r$1.Children.count(e.children) && console.warn("The global style component " + a + " was given child JSX. createGlobalStyle does not render children."),
        i.some((function(e) {
...
var Ue = /^\s*<\/[a-z]/i
  , Je = function() {
    ...
    return t.collectStyles = function(e) {
        return this.sealed ? D(2) : r$1.createElement(me, {
            sheet: this.instance
        }, e)
    }
    ,
  ...
  , Xe = function(e) {
    var t = r$1.forwardRef((function(t, n) {
        var o = useContext(Me)
          , i = e.defaultProps
          , a = Oe(t, o, i);
        return void 0 === a && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "' + b(e) + '"'),
        r$1.createElement(e, y({}, t, {
            theme: a,
            ref: n
        }))
    }
    ));
    return hoistNonReactStatics_cjs(t, e),
...
"undefined" != typeof window && (window["__styled-components-init__"] = window["__styled-components-init__"] || 0,
...
export { Je as ServerStyleSheet, ue as StyleSheetConsumer, ce as StyleSheetContext, me as StyleSheetManager, Ge as ThemeConsumer, Me as ThemeContext, Le as ThemeProvider, Ke as __PRIVATE__, $e as createGlobalStyle, Ae as css, qe as default, _ as isStyledComponent, We as keyframes, Ze as useTheme, A as version, Xe as withTheme };
