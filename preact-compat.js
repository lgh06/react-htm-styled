// https://cdn.jsdelivr.net/npm/preact@10.6.4/compat/dist/compat.module.js  
// with preact & preact/hooks location modified.


// https://cdn.jsdelivr.net/npm/preact@10.6.4/hooks/dist/hooks.module.js
...
function g(n, t) {
    ...
    return r.displayName = "Memo(" + (n.displayName || n.name) + ")",
...
function x(n) {
    function t(t, e) {
        var r = S({}, t);
        return delete r.ref,
        n(r, (e = t.ref || e) && ("object" != typeof e || "current"in e) ? e : null)
    }
    return t.$$typeof = R,
    t.render = t,
...
L.prototype.render = function(n, t) {
    if (this.__b) {
        if (this.__v.__k) {
            ...
            this.__v.__k[0] = function n(t, e, r) {
                ...
                t.__c.__H = null),
                null != (t = S({}, t)).__c && (t.__c.__P === r && (t.__c.__P = e),
                t.__c = null),
                t.__k = t.__k && t.__k.map(function(t) {
                    return n(t, e, r)
                })),
    ...
    return u && (u.__h = null),
    [s(v, null, t.__e ? null : n.children), u]
}
;
...
h.vnode = function(n) {
    ...
    if ("string" == typeof t) {
        ...
        e) {
            var i = e[o];
            V && "children" === o && "noscript" === t || "value" === o && "defaultValue"in e && null == i || ("defaultValue" === o && "value"in e && null == e.value ? o = "value" : "download" === o && !0 === i ? i = "" : /ondoubleclick/i.test(o) ? o = "ondblclick" : /^onchange(textarea|input)/i.test(o + t) && !z(e.type) ? o = "oninput" : /^onfocus$/i.test(o) ? o = "onfocusin" : /^onblur$/i.test(o) ? o = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp)/.test(o) ? o = o.toLowerCase() : u && P.test(o) ? o = o.replace(/[A-Z0-9]/, "-$&").toLowerCase() : null === i && (i = void 0),
            r[o] = i)
        }
        ...
        n.props = r,
        e.class != e.className && (J.enumerable = "className"in e,
